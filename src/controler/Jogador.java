...
public class Jogador{
	...
	public Jogador(String nome, int w, int m, int a) throws SlickException
	{
		this.nome = nome;
		herois[0] = new Heroi("warrior", 150, 200, w);
		herois[1] = new Heroi("mage", 40, 180, m);
		herois[2] = new Heroi("archer", 30, 300, a);
	}
