...
import animacoes.PersonagemAnimacao;
...
public abstract class  Personagem {
	...
	public Personagem(String nome, int x, int y, int skin) throws SlickException
	{
		...
		this.nome = nome;
		animacao = new PersonagemAnimacao(nome+"/"+skin, x, y); 
	}
